...
| R3  | Dados da API expiram em 30 dias corridos                            | `refreshedAt` obrigatório no schema; job `purgeCache` diário; `countExpired` como auditoria, verificada em teste              | ✅ coberto                        |
